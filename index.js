    ...
    /******/ [
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            function init() {
                ...
                var initialHandlers =
                    _ref$initialHandlers === undefined
                        ? defaultHandlers
                        : _ref$initialHandlers;
            ...
            function setAsTriggerElement(triggerElement) {
                if (triggerElement) {
                    ...
                    var params = {};
                    triggerElement.href = (0, _commonUtils.buildUrl)(
                        basePath + _commonConstants.Endpoints.POPUP,
                        params
                    );
                    ...
                    triggerElement.addEventListener('click', function (e) {
                        ...
                        if (
                            ...
                            _commonConstants.State.DISABLED
                        ) {
                            e.preventDefault();
                        }
                        ...
                        if (
                            currentNotificationState ==
                            _commonConstants.State.ENABLED
                        ) {
                            crosserInstance.triggerEvent(
                                _commonConstants.Event.UNSUBSCRIBE,
                                {}
                            );
                        }
                    });
            ...
            function createFrame(onLoad) {
                ...
                f.id = frameId;
                f.onload = onLoad;
                f.src = (0, _commonUtils.buildUrl)(
                    basePath + _commonConstants.Endpoints.FRAME,
                    _defineProperty(
                        {},
                        _commonConstants.Consts.PARENT_ORIGIN_PARAM,
                        myDomain
                    )
                );
                return f;
            ...
            function initCrosser() {
                ...
                crosserInstance = new _commonCrossFrame2['default'](
                    frameInstance.contentWindow,
                    frameDomain
                );
                listenToEvents();

                crosserInstance.triggerEvent(
                    _commonConstants.Event.INIT,
                    ((_crosserInstance$triggerEvent = {}),
                    _defineProperty(
                        _crosserInstance$triggerEvent,
                        _commonConstants.Consts.SITE_DOMAIN_PARAM,
                        myDomain
                    ),
                    _defineProperty(
                        _crosserInstance$triggerEvent,
                        _commonConstants.Consts.INITIAL_PUSH_SUPPORT_PARAM,
                        initialPushSupportIndicator
                    ),
                    _defineProperty(
                        _crosserInstance$triggerEvent,
                        _commonConstants.Consts.SITE_ALIAS_PARAM,
                        siteAlias
                    ),
                    _crosserInstance$triggerEvent)
                );
            ...
            function listenToEvents() {
                crosserInstance.subscribeEvent(
                    _commonConstants.Event.CHANGE_NOTIFICATION_STATUS,
                    function (data) {
                ...
                crosserInstance.subscribeEvent(
                    _commonConstants.Event.ADD_SUBSCRIPTION,
                    function (data) {
                        fireSafe(handlers.addSubscription, data);
                    }
                );
                crosserInstance.subscribeEvent(
                    _commonConstants.Event.REMOVE_SUBSCRIPTION,
                    function (data) {
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            function Crosser(otherFrameWindow, origin) {
                ...
                if (
                    !this._otherFrameWindow ||
                    !this._otherFrameWindow.postMessage
                ) {
            ...
            Crosser.prototype._endSession = function (event) {
                var message = event.data;
                var resolve =
                    this._sessionHandlers[message.sessionName].resolve;
            ...
            Crosser.prototype._throwBackSession = function (event) {
                ...
                Object.keys(this._listeners[sessionName] || {}).forEach(
                    function (subscriberId) {
                        var callbackResult = this._listeners[sessionName][
                            subscriberId
                        ](message.payload);
            ...
            Crosser.prototype.destroy = function () {
                ...
                Object.keys(this._sessionHandlers || {}).forEach(
                    this._deleteSession,
                    this
                );
            ...
            Crosser.prototype.subscribe = function (sessionName, callback) {
                ...
                this._listeners[sessionName] =
                    this._listeners[sessionName] || {};
                if (
                    Object.keys(this._listeners[sessionName] || {}).length > 0
                ) {
                    throw new Error(
                        'A session ( ' +
                            sessionName +
            ...
            Crosser.prototype.unsubscribe = function (
                sessionName,
                subscriberId
            ) {
                if (!subscriberId) {
                    Object.keys(this._listeners[sessionName] || {}).forEach(
                        this.unsubscribe.bind(this, sessionName)
                    );
                } else {
	...
	*/
                    ...
                    function () {
                        ...
                        function a(n) {
                            ...
                            (this.then = function (n, r) {
                                ...
                                return (
                                    (i.promise = new this.constructor(function (
                                        t,
                                        n
                                    ) {
                                        if (
        ...
        /***/ function (module, exports, __webpack_require__) {
            /* WEBPACK VAR INJECTION */ (function (
                ...
                exports,
                __webpack_require__(4).setImmediate,
                __webpack_require__(4).clearImmediate
            ));
        ...
        /***/ function (module, exports) {
            ...
            var Endpoints = {
                ...
                NOTIFICATIONS:
                    '/_dm/s/rt/api/public/rt/site/{siteAlias}/notifications/lastsent',
                ICON: '/api/icon',
                PROXY: '/api/proxy',
            };
        ...
        /***/ function (module, exports) {
            ...
            exports.storeSubscriptionLocallyAndCompare =
                storeSubscriptionLocallyAndCompare;
            ...
            function buildUrl(url, paramsObj) {
                ...
                Object.keys(paramsObj).forEach(function (k) {
                    resultArray.push(
                        k + '=' + encodeURIComponent(paramsObj[k])
                    );
                });
            ...
            function storeSubscriptionLocallyAndCompare(
                newSubscription,
                callbackWhenDifferent
            ) {
                ...
                try {
                    ...
                    if (storage) {
                        var currentKnownSubscription =
                            JSON.parse(
                                storage.getItem('currentKnownSubscription') ||
                                    '{}'
                            ) || {};
